...
local Window = OrionLib:MakeWindow({Name = "abacaxi hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "abacaxi hub"})
...
W:AddLabel("[+] abacaxi hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "abacaxi hub(Noitification)",
